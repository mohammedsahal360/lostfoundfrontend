...
document.addEventListener('DOMContentLoaded', () => {
    ...
    loginForm?.addEventListener('submit', (event) => {
        ...
        if (user_id === hardcodedUserId && password === hardcodedPassword) {
            sessionStorage.setItem('loggedIn', 'true'); // Set logged-in status in session storage
            setLogoutLink();
    ...
    // Function to change login link to logout
    function setLogoutLink() {
        ...
        loginLink.onclick = (e) => {
            ...
            loginLink.href = 'login.html'; // Set link back to login page
        };
    }
});
